...
// Fetch Feedback Table With Status (0)
$sql = "SELECT * FROM feedback WHERE status = '1' ORDER BY id DESC lIMIT $start_form, $total_num_page";
...
<div class="content">
    ...
    <div class="pagination">
        ...
        if ($total_record > 10) {
        echo '<a href="feedback_notification.php?page_id=' . $i . '">' . $i . '</a>';
        } else {
        echo '';
        }
        }
